...
export class ReqMappingEditDialogComponent {
  ...
  onFileChange(event: Event) {
    ...
    if (fileInput?.files?.length) {
      this.reqForm.patchValue({ openNumbersProof: fileInput.files[0] });
    } else {
    ...
    if (this.reqForm.valid) {
      ...
      if (this.isHiringUpdate === true) {
        ...
        const proofFile: File | undefined =
          this.reqForm.get('openNumbersProof')?.value;
...
req-mapping-edit-dialog.comp.html
    ...
    <div class="req-edit-body">
      ...
      <div class="row">
        ...
        <!-- <div class="col-lg-4 col-sm-4" *ngFor="let field of formFields">
         ...
         <div class="col-sm-4">
          <div class="form-group ags-form-group">
            <label for="closureDate" class="form-label"
              >Closure Date<span class="required"></span
            ></label>
        ...
        <div class="col-sm-4">
          <div class="form-group ags-form-group">
            <label for="onboardingDate" class="form-label"
              >Onboarding Date<span class="required"></span
            ></label>
            <div class="form-datepicker">
              <input
                #dob
            ...
            <mat-datepicker #onboardPicker></mat-datepicker>
          </div>
        </div>
