...
panel-reschedule.component
import { MessageModalsComponent } from '@/src/app/common-modules/message-modals/message-modals.component';
import { ElasticSearchResponse, CandidateApplication } from '@/src/app/interfaces/app-interface';
...
import { Observable, map, catchError, of, startWith, debounceTime, switchMap } from 'rxjs';
import { PanelScheduleDialogComponent } from '../panel-schedule-dialog/panel-schedule-dialog.component';
...
@Component({
  selector: 'app-panel-reschedule-dialog',
  templateUrl: './panel-reschedule-dialog.component.html',
  styleUrls: ['./panel-reschedule-dialog.component.scss'],
})
export class PanelRescheduleDialogComponent
    ...
    implements OnInit
  {
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<PanelRescheduleDialogComponent>
    ) {
      super(media);
  ...
  listenForValueChanges1(event: any) {
